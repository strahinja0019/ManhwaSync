...
import com.strahinja0019.manhwasync.ui.theme.getPrimaryColor
...
fun SettingsScreen(
    ...
    Column(
        ...
        /*
        & $env:LOCALAPPDATA\Android\Sdk\platform-tools\adb.exe -s emulator-5554 shell am broadcast -a android.appwidget.action.APPWIDGET_UPDATE --eia appWidgetIds 6 -n com.strahinja0019.manhwasync/.RandomManhwaWidget
         */
        ...
        Button(
            ...
            val thisWidget = android.content.ComponentName(context, RandomManhwaWidget::class.java)
            val appWidgetIds = appWidgetManager.getAppWidgetIds(thisWidget)
            val intent = Intent(context, RandomManhwaWidget::class.java).apply {
        ...
        Button(
            ...
            onClick = {
            // Fires the intent instantly through your companion object helper
            MainActivity.triggerInstantTestNotification(context)
        }) {
        ...
        Text(if(currentTheme.displayName.equals("Secret")){"Secret enabled"}else{"Shake for a secret (3 sec with consistent force)"})
